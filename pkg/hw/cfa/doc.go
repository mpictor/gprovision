...
//
// data is the payload of the packet. Each type of packet will have a specified
// data_length and format for data as well as algorithms for decoding data
// detailed below.
//
// CRC is a standard 16-bit CRC of all the bytes in the packet except the CRC
// itself. The CRC is sent LSB first. At the port, the CRC immediately follows
// the last used element of data []. See Sample Algorithms To Calculate The CRC
// (Pg. 66) for details.
//
